...
var utils = module.exports = {
     ...
     * Adds own enumerable attributes of source objects onto destination object.
     *
     * @param {Object} dest - Destination object
     * @param {...Object} - Source objects
     * @returns {Object} dest - Destination object
     */
    objectExtend: function(dest) {
        var src, key;
        for (var i = 1; i < arguments.length; i++) {
            src = arguments[i];
            for (key in src) {
                if (Object.prototype.hasOwnProperty.call(src, key) && src[key] !== undefined) dest[key] = src[key];
            }
        }
        return dest;
    },
     ...
     * Returns object which is clone of source object.
     * i.e. copies own enumarable attributes of source object to new object.
     *
     * @param {Object} obj - Object to be cloned
     * @returns {Object} clone - Cloned object
     */
    objectClone: function(obj) {
        return utils.objectExtend({}, obj);
    },
