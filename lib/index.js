...
class Pluggi {
	...
	constructor(options) {
		...
		this.plugin(pluginPlugin);
		this.plugin(pluginsPlugin);
	}
	...
	plugin(name, plugin, options) {
		...
		options = Object.assign({}, this._options[name], options);
		...
		const res = plugin.init(this, options);
 ...
 *   - subclass of Plugin (identifies by function check)
 */
function isPlugin(obj) {
	return typeof obj == 'function' || obj instanceof Plugin;
}
